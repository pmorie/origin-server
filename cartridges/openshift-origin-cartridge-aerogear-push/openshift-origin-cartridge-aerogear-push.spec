...
%changelog
* Tue Nov 19 2013 Paul Morie <pmorie@gmail.com> 1.0.12-1
- Incorporating the relevant recent jbossas cartridge changes (starting from
  commit https://github.com/openshift/origin-
  server/commit/ff25ac5fe73a526bc94b7420ce7c4ed40fdaa2d3 up until
  https://github.com/openshift/origin-
  server/commit/0a932b9feae96ae46e4cfe1c5346f486919fddfe). (fjuma@redhat.com)
- AGPUSH-378 Installing the SimplePush and UnifiedPush binaries via RPMs
  instead of including these binaries in the cartridge source. Also updating
  the SimplePush subsystem configuration. RPMs now contain 0.9.0 versions:
  (fjuma@redhat.com)
- Adding UP 0.8.1 (matzew@apache.org)
- Updating SimplePush Server to 0.8.1 (daniel.bevenius@gmail.com)
- * don't expand OPENSHIFT_APP_DNS (jhonce@redhat.com)
- Cartridge - Print credentials via client_result (jhonce@redhat.com)
- Removing java7 marker file to force java6. (daniel.bevenius@gmail.com)
- Automatic commit of package [openshift-origin-cartridge-aerogear-push]
  release [1.0.11-1]. (pmorie@gmail.com)
